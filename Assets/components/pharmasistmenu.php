...
<div id="application-sidebar" class="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 start-0 bottom-0 z-[60] w-64 bg-white border-e border-gray-200 pt-7 pb-10 overflow-y-auto lg:block lg:translate-x-0 lg:end-auto lg:bottom-0 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-slate-700 dark:[&::-webkit-scrollbar-thumb]:bg-slate-500 dark:bg-gray-800 dark:border-gray-700">
    ...
    <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
        <ul class="space-y-1.5">
            <li>
                <a class="flex items-center gap-x-3.5 py-2 px-2.5 <?= ($_SERVER['PHP_SELF'] == '/HMS/Pharmacist/dashboard.php')? 'bg-gray-100 ':''?>text-sm text-slate-700 rounded-lg hover:bg-gray-100 dark:bg-gray-900 dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="dashboard.php">
            ...
            <li class="hs-accordion <?= ($_SERVER['PHP_SELF'] == '/HMS/Pharmacist/adddrug.php')? 'active':''?> <?= ($_SERVER['PHP_SELF'] == '/HMS/Pharmacist/addarival.php')? 'active ':''?> " id="users-accordion">
                ...
                <div id="account-accordion-child" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 <?= ($_SERVER['PHP_SELF'] == '/HMS/Pharmacist/adddrug.php') || ($_SERVER['PHP_SELF'] == '/HMS/Pharmacist/addarival.php')? 'active ':'hidden'?>">
                    <ul class="pt-2 ps-2">
                        <li>
                            <a class="flex items-center gap-x-3.5 py-2 px-2.5 <?= ($_SERVER['PHP_SELF'] == '/HMS/Pharmacist/adddrug.php')? 'bg-gray-100 ':''?> text-sm text-slate-700 rounded-lg hover:bg-gray-100 dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="<?="adddrug.php" ?>">
                                ADD Drug
                            </a>
                        </li>
                        <li>
                            <a class="flex items-center gap-x-3.5 py-2 px-2.5 <?= ($_SERVER['PHP_SELF'] == '/HMS/Pharmacist/addarival.php')? 'bg-gray-100 ':''?> text-sm text-slate-700 rounded-lg hover:bg-gray-100 dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="<?="addarival.php" ?>">
                                ADD arrival
                            </a>
                        </li>
                    </ul>
