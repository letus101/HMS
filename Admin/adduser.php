...
if (isset($_POST['adduser'])) {
    ...
    $username = strtolower($firstName).'.'.strtolower($lastName).'@hospitalink.com';
            ...
            <div class="grid grid-cols-1 gap-6 p-4">
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div class="flex justify-end">
                        <button onclick="return(confirmAddUser())" type="submit" name="adduser" class="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md shadow-sm hover:bg-blue-700 focus:outline-none dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 dark:focus:ring-1 dark:focus:ring-gray-600">
                            Add user
                        </button>
                    </div>
                </div>
